document.write(`
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/metro/4.3.8/css/metro-all.min.css">
    ...
    <!-- Metro UI JS-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/metro/4.3.8/js/metro.min.js"></script>
    <!-- Latex imports -->
    <script>
      MathJax = {
        tex: {
